...
class CNFutureTransactionCostDecider(AbstractTransactionCostDecider):
    ...
    def get_trade_commission(self, trade):
        return self._get_commission(
            trade.order_book_id, trade.position_effect, trade.last_price, trade.last_quantity, trade.close_today_amount, trade.trading_datetime
        )
    ...
    def get_order_transaction_cost(self, order):
        ...
        return self._get_commission(
            order.order_book_id, order.position_effect, order.frozen_price, order.quantity, close_today_quantity, order.trading_datetime
        )
