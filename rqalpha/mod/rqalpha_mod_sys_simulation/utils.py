...
def init_portfolio(env):
    ...
    for account_type in config.base.account_list:
        if account_type == ACCOUNT_TYPE.STOCK:
            ...
            StockAccount = env.get_account_model(ACCOUNT_TYPE.STOCK)
            StockPosition = env.get_position_model(ACCOUNT_TYPE.STOCK)
            ...
            FutureAccount = env.get_account_model(ACCOUNT_TYPE.FUTURE)
            FuturePosition = env.get_position_model(ACCOUNT_TYPE.FUTURE)
