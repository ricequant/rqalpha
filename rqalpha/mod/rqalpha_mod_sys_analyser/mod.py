...
class AnalyserMod(AbstractMod):
    ...
    def tear_down(self, code, exception=None):
        ...
        # 最大回撤持续期
        summary.update({
            "max_drawdown_duration": _max_dd(total_portfolios.unit_net_value.values, total_portfolios.index).repr
        })
        ...
        if self._benchmark:
            ...
            result_dict["summary"]["excess_max_drawdown_duration"] = _max_dd(ex_returns + 1, total_portfolios.index).repr
        else:
