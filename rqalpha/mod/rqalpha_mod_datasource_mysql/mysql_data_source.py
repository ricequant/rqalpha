...
from .models import StockDataDaily, IndexDaily
...
class MysqlDataSource(AbstractDataSource):
    ...
    def __init__(self, path, custom_future_info):
        ...
        self._day_bars = {
            INSTRUMENT_TYPE.CS: DayBarStore(StockDataDaily),  # 股票
            INSTRUMENT_TYPE.INDX: DayBarStore(IndexDaily),  # 指数
...
#         super(MysqlDataSource, self).__init__(path, {})
#
#
#
...
#             return super(MysqlDataSource, self).history_bars(instrument, bar_count, frequency, fields, dt, skip_suspended)
#
...
#             return super(MysqlDataSource, self).get_bar(instrument, dt, frequency)
#         else:
#             if isinstance(fields, six.string_types):
#                 fields = [fields]
